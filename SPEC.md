...
- **Emphasis extraction** — yellow/green PDF highlights read as retrieval signal (`EMPHASIS_EXTRACTION_ENABLED`): extra lexical terms and chunk metadata, never rewritten passage text. The operational manuals title their sections and mark critical values with highlights, which no heading regex was going to recover.
